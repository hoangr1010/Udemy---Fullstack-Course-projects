...
export type ReactMarkdownProps = import('react-markdown/lib/complex-types').ReactMarkdownProps
export type Raw = {
  type: 'raw'
  value: string
}
...
export type Components = Partial<
  Omit<import('react-markdown/lib/complex-types').NormalComponents, keyof SpecialComponents> &
    SpecialComponents
>
export type Options = {
  ...
  components?:
    | Partial<
        Omit<
          import('react-markdown/lib/complex-types').NormalComponents,
